...
describe('LightDomElement test', () => {
    it('passed title attribute', async () => {
        const el = await fixture(html `<light-dom-element title="Hey there"></light-dom-element>`);
        expect(el.title).to.equal('Hey there');
    });
    it('can override the title via attribute', async () => {
        const el = await fixture(html `<light-dom-element
...
//# sourceMappingURL=light-dom-element-ts.test.js.map